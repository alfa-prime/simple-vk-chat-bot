...
3. [Как получить требуемые значения для настройки приложения](documentation/get_and_set_values.MD)
4. Для начала диалога с ботом отправить ему команду "Начать"
